...
.post('/sign_in', function (ctx, next) {
  return _koaPassport["default"].authenticate('local', function (user, err) {
    if (!user) {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.t0 = ctx.query.type.toLowerCase();
            _context4.next = _context4.t0 === "applicant" ? 3 : _context4.t0 === "company" ? 7 : 11;
            break;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 4:
            ...
            _context7.t0 = ctx.query.type.toLowerCase();
            _context7.next = _context7.t0 === "applicant" ? 9 : _context7.t0 === "company" ? 11 : 13;
            break;
